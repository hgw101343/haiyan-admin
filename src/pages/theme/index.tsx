            ...
            <Col key={preset.name} xs={12} sm={8} md={6} lg={4}>
              ...
              >
                ...
                {theme.primaryColor === preset.colors.primaryColor && (
                  <Tag color="blue" className="preset-tag">
                    当前
                  </Tag>
                )}
              </div>
        ...
        <Col xs={24} md={8}>
          <Card title="小程序预览" style={{ position: "sticky", top: 24 }}>
            <div className="phone-preview">
              ...
              >
                <div className="phone-navbar-title">海宴私厨</div>
              </div>
                ...
                {[1, 2].map((i) => (
                  ...
                  >
                    ...
                    <div className="phone-dish-info">
                      <div
                        className="phone-dish-name"
                        style={{ color: theme.textColor }}
                      >
                        菜品名称
                      </div>
                      <div
                        className="phone-dish-desc"
              ...
              >
                {["首页", "菜单", "购物车", "订单", "我的"].map((label, i) => (
                  <div
                    ...
                    style={{
                      color:
                        i === 0 ? theme.tabBarSelectedColor : theme.tabBarColor,
                    }}
                  >
                    <div
              ...
              children: (
                <Row gutter={[16, 16]}>
                  {group.keys.map((key) => {
                    ...
                    const label =
                      group.labels[key as keyof typeof group.labels];
                    const isTextStyle =
                      group.isTextStyle && key === "navBarTextStyle";
